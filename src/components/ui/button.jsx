...
import { Slot } from "@radix-ui/react-slot"; // Slot ইমপোর্ট করুন
...
function Button({
  ...
  variant = "default",
  size = "default",
  asChild = false, // asChild প্রপ যুক্ত করুন
  ...props
}) {
  // যদি asChild ট্রু হয়, তবে Slot ব্যবহার করুন, নাহলে ButtonPrimitive
