...
const FeaturedStartups = () => {
  ...
  return (
    <div className="bg-white dark:bg-[#0d0f17] text-gray-900">
      <section className="max-w-7xl mx-auto dark:text-white px-6 md:px-10 py-20 transition-colors duration-300">
        {/* Header */}
